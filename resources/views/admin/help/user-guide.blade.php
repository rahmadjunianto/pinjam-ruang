            ...
            <div class="card card-primary card-outline sticky-top">
                ...
                <div class="card-body p-0">
                    <nav class="nav nav-pills flex-column">
                        ...
                        <a class="nav-link" href="#login">Login ke Sistem</a>
                        <a class="nav-link" href="#dashboard">Dashboard</a>
                        <a class="nav-link" href="#booking">Membuat Peminjaman</a>
                        <a class="nav-link" href="#calendar">Melihat Kalender</a>
                        <a class="nav-link" href="#profile">Mengelola Profil</a>
                        <a class="nav-link" href="#notifications">Notifikasi</a>
                        <a class="nav-link" href="#troubleshooting">Pemecahan Masalah</a>
                    </nav>
                </div>
            </div>
        </div>
